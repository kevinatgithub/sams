Public Class New_Employee_3
    Inherits MetroFramework.Forms.MetroForm

    Public CurrentEmployee As Employee
    Public PreviousStep As New_Employee_2

    Sub New(PreviousStep As New_Employee_2, CurrentEmployee As Employee)
    ...
    Private Sub btn_next_Click(sender As Object, e As EventArgs) Handles btn_next.Click
        ...
        Dim NextStep As New New_Employee_4(Me, CurrentEmployee)
        NextStep.Show()
        Me.Hide()
